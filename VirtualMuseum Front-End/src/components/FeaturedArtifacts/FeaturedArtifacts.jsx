...
export default function FeaturedArtifacts() {
  ...
  const featured = artifactsData.slice(0, 3);
    ...
    <section className="py-32 bg-[#050505] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-24">
          ...
          >
            <Sparkles size={18} />
            <span className="font-black tracking-[0.5em] text-[10px] uppercase">Masterpieces</span>
            <Sparkles size={18} />
          </motion.div>
          ...
          >
            Ancient <span className="italic text-[#D4AF37]">Treasures</span>
          </motion.h2>
          <p className="text-gray-500 max-w-2xl mx-auto text-sm leading-relaxed tracking-wide">
            Witness the most prestigious artifacts recovered from the golden sands of Egypt.
          </p>
        </div>
